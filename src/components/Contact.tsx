...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In a real scenario, you'd handle form submission to your backend here
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-growzzy-primary min-h-[120px]"
                  required
                ></textarea>
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="p-3 bg-growzzy-light rounded-full text-growzzy-primary hover:bg-growzzy-primary hover:text-white transition-colors">
