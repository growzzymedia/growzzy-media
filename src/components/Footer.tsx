      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md text-justify">A digital-first, performance-driven marketing agency that helps brands stand out using AI, connect with their audience, and achieve measurable growth in today's competitive digital landscape. Serving clients globally with a focus on AI-powered digital solutions.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/connect" className="text-gray-300 hover:text-white transition-colors">Connect</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <p className="text-gray-300 mt-4">Serving clients globally with a focus on AI-powered digital solutions.</p>
            </ul>
          </div>
        </div>
