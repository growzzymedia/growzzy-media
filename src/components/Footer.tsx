    ...
    <footer className="bg-growzzy-dark text-white py-16">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              A digital-first, performance-driven marketing agency that helps brands stand out and achieve measurable growth.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="mt-4 md:mt-0 bg-growzzy-primary hover:bg-growzzy-primary/80 text-white p-3 rounded-full transition-colors"
