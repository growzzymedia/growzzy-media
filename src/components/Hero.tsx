      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          animationDelay: '0.2s'
            ...
            AI-Driven <span className="text-growzzy-primary text-3xl font-bold">Digital Marketing Agency</span> | Performance Marketing that <span className="text-growzzy-primary">Drives Results</span>
          </h1>
          <p style={{
          animationDelay: '0.4s'
