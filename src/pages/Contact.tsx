...
const ContactPage = () => {
  useEffect(() => {
    document.title = "Contact Us | Growzzy Media";
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 fade-in-section" data-delay="0.2">
                Let's discuss what your business needs to thrive online. Fill out the form below and we'll be in touch shortly.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p>
                          Serving clients globally with a focus on digital solutions
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-16 md:py-24 bg-growzzy-gray">
          <div className="container">
            <div className="text-center max-w-xl mx-auto mb-16">
              <h2 className="text-3xl font-display font-semibold mb-4 fade-in-section">Frequently Asked Questions</h2>
              <p className="text-muted-foreground fade-in-section" data-delay="0.1">
                Have questions before reaching out? Here are some common inquiries.
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    a: "We offer a comprehensive suite of digital marketing services including paid advertising (Google & Meta), organic social media management, LinkedIn growth, website development, and custom marketing solutions."
                  },
                  {
                    q: "How much do your services cost?",
                    a: "Our services are customized to each client's specific needs, goals, and budget. We offer various packages and pricing models based on project scope and ongoing requirements. Contact us for a personalized quote."
                  },
                  {
                    q: "How long does it take to see results?",
                    a: "Results timeline varies by service and your starting point. Paid advertising typically shows initial results within 2-4 weeks. Organic strategies like content marketing and SEO take 3-6 months to gain significant traction."
                  },
                  {
                    q: "Do you work with international clients?",
                    a: "Yes! We work with clients globally. Our team is experienced in managing digital marketing across different markets and regions."
                  }
                ].map((faq, index) => (
                  <div key={index} className="bg-white p-6 rounded-lg shadow-md fade-in-section" data-delay={`${0.2 + index * 0.1}`}>
