...
const ServicesPage = () => {
  ...
  const services = [{
    ...
    details: ["Campaign strategy & planning", "Ad creative development", "A/B testing & optimization", "Performance tracking & analytics", "Budget management", "Monthly reporting"]
  }, {
    ...
    details: ["Content calendar development", "Platform-specific content creation", "Hashtag & trend research", "Community management", "Engagement strategies", "Analytics & growth tracking"]
  }, {
    ...
    details: ["Profile optimization", "Content strategy development", "Ghostwriting & post creation", "Connection growth strategies", "Engagement tactics", "Thought leadership positioning"]
  }, {
    icon: <Globe className="w-10 h-10" />,
    title: "Website Development",
    description: "Clean, aesthetic websites that convert visitors into leads and customers.",
    details: ["Custom design & development", "Mobile-responsive layouts", "SEO optimization", "Lead capture integration", "Analytics setup", "Maintenance & support"]
  }, {
    ...
    details: ["Digital strategy consulting", "Marketing automation", "CRM integration", "Conversion optimization", "Analytics & reporting systems", "Training & team development"]
  }];
        ...
        <section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-growzzy-light relative overflow-hidden">
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p data-delay="0.2" className="text-xl text-muted-foreground mb-8 fade-in-section text-justify md:text-lg font-normal">We offer a comprehensive suite of digital marketing services designed to help your brand grow.

We’re not just a marketing agency — we’re your AI-powered growth partner.
At Growzzy Media, every campaign is fueled by machine learning, performance data, and audience intent — not guesswork. From smart ad bidding to automated SEO and trend-predictive content, our stack learns what converts faster than any team alone.
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            {services.map((service, index) => <div key={index} className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-8 mb-20 fade-in-section`} data-delay={`${0.1 * index}`}>
